...
* [ADSB.lol](https://adsb.lol) - A completely open-source and community-driven flight tracker that displays and provides [ODbL-licensed](https://opendatacommons.org/licenses/odbl/summary/) data via a [free API](https://api.adsb.lol/) as well as [free historical data](https://github.com/adsblol/globe_history) ⭐ 54 | 🐛 0 | 🌐 Shell | 📅 2026-09-26.
...
* [readsb](https://github.com/wiedehopf/readsb) ⭐ 685 | 🐛 11 | 🌐 C | 📅 2026-09-24 - ADS-B decoder swiss knife.
* [junzis/pyModeS](https://github.com/junzis/pyModeS) ⭐ 669 | 🐛 7 | 🌐 Python | 📅 2026-09-24 - A python decoder for Mode S and ADS-B signals.
* [sdr-enthusiasts/plane-alert-db](https://github.com/sdr-enthusiasts/plane-alert-db) ⭐ 145 | 🐛 8 | 🌐 Python | 📅 2026-09-23 - A list of exciting aircraft - Governments, Dictators, Military, Historical and just plain odd.
...
* [sdr-enthusiasts/docker-adsb-ultrafeeder](https://github.com/sdr-enthusiasts/docker-adsb-ultrafeeder) ⭐ 573 | 🐛 7 | 🌐 Shell | 📅 2026-09-20 - All-in-one ADSB container with readsb, tar1090, graphs1090, autogain, multi-feeder, and mlat-hub built in.
* [adsbfi/adsb-fi-scripts](https://github.com/adsbfi/adsb-fi-scripts) ⭐ 188 | 🐛 0 | 🌐 Shell | 📅 2025-08-29 - Easy to use feeder install script for feeding to adsb.fi.
