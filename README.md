...
* [ADSB.lol](https://adsb.lol) - A completely open-source and community-driven flight tracker that displays and provides [ODbL-licensed](https://opendatacommons.org/licenses/odbl/summary/) data via a [free API](https://api.adsb.lol/) as well as [free historical data](https://github.com/adsblol/globe_history) ⭐ 54 | 🐛 1 | 🌐 Shell | 📅 2026-09-19.
...
* [readsb](https://github.com/wiedehopf/readsb) ⭐ 683 | 🐛 11 | 🌐 C | 📅 2026-09-18 - ADS-B decoder swiss knife.
...
* [sdr-enthusiasts/docker-adsb-ultrafeeder](https://github.com/sdr-enthusiasts/docker-adsb-ultrafeeder) ⭐ 567 | 🐛 6 | 🌐 Shell | 📅 2026-09-18 - All-in-one ADSB container with readsb, tar1090, graphs1090, autogain, multi-feeder, and mlat-hub built in.
...
* [wiedehopf/tar1090](https://github.com/wiedehopf/tar1090) ⭐ 1,910 | 🐛 68 | 🌐 JavaScript | 📅 2026-09-05 - A great way to view your ADS-B data.
* [amnesica/BelugaProject](https://github.com/amnesica/BelugaProject) ⭐ 87 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-19 - A web application that displays data of one or multiple, local ADS-B feeders and AIS-data along with additional information on a map interface in the browser.
...
* [Jxck-S/plane-notify](https://github.com/Jxck-S/plane-notify) ⭐ 2,548 | 🐛 10 | 🌐 Python | 📅 2026-09-15 - Notify if a selected plane has taken off or landed using OpenSky or ADS-B Exchange data.
...
> **TODO:**
> Please [create a pull request](https://github.com/rickstaa/awesome-adsb/pulls) ⭐ 383 | 🐛 12 | 🌐 HTML | 📅 2026-09-05 if you know people in the ADS-B space that are worth following.

Who else should we [be following](https://github.com/rickstaa/awesome-adsb/issues/new?assignees=\&labels=\&template=suggestion.yaml) ⭐ 383 | 🐛 12 | 🌐 HTML | 📅 2026-09-05?
...
This project exists thanks to all the people [that contributed](https://github.com/rickstaa/awesome-adsb/graphs/contributors) ⭐ 383 | 🐛 12 | 🌐 HTML | 📅 2026-09-05!
