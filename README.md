...
* [ADSB.lol](https://adsb.lol) - A completely open-source and community-driven flight tracker that displays and provides [ODbL-licensed](https://opendatacommons.org/licenses/odbl/summary/) data via a [free API](https://api.adsb.lol/) as well as [free historical data](https://github.com/adsblol/globe_history) ⭐ 54 | 🐛 1 | 🌐 Shell | 📅 2026-09-16.
...
* [readsb](https://github.com/wiedehopf/readsb) ⭐ 680 | 🐛 11 | 🌐 C | 📅 2026-08-22 - ADS-B decoder swiss knife.
...
* [sdr-enthusiasts/docker-adsb-ultrafeeder](https://github.com/sdr-enthusiasts/docker-adsb-ultrafeeder) ⭐ 567 | 🐛 5 | 🌐 Shell | 📅 2026-09-13 - All-in-one ADSB container with readsb, tar1090, graphs1090, autogain, multi-feeder, and mlat-hub built in.
...
* [wiedehopf/tar1090](https://github.com/wiedehopf/tar1090) ⭐ 1,903 | 🐛 57 | 🌐 JavaScript | 📅 2026-09-05 - A great way to view your ADS-B data.
