...
* [ADSB.lol](https://adsb.lol) - A completely open-source and community-driven flight tracker that displays and provides [ODbL-licensed](https://opendatacommons.org/licenses/odbl/summary/) data via a [free API](https://api.adsb.lol/) as well as [free historical data](https://github.com/adsblol/globe_history) ⭐ 45 | 🐛 0 | 🌐 Shell | 📅 2026-08-23.
...
* [readsb](https://github.com/wiedehopf/readsb) ⭐ 659 | 🐛 10 | 🌐 C | 📅 2026-08-22 - ADS-B decoder swiss knife.
...
* [sdr-enthusiasts/docker-adsb-ultrafeeder](https://github.com/sdr-enthusiasts/docker-adsb-ultrafeeder) ⭐ 555 | 🐛 2 | 🌐 Shell | 📅 2026-08-23 - All-in-one ADSB container with readsb, tar1090, graphs1090, autogain, multi-feeder, and mlat-hub built in.
...
* [wiedehopf/tar1090](https://github.com/wiedehopf/tar1090) ⭐ 1,882 | 🐛 57 | 🌐 JavaScript | 📅 2026-07-28 - A great way to view your ADS-B data.
