...
* [readsb](https://github.com/wiedehopf/readsb) ⭐ 661 | 🐛 10 | 🌐 C | 📅 2026-08-22 - ADS-B decoder swiss knife.
...
* [amnesica/BelugaProject](https://github.com/amnesica/BelugaProject) ⭐ 84 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-07 - A web application that displays data of one or multiple, local ADS-B feeders and AIS-data along with additional information on a map interface in the browser.
