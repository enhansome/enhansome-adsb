...
* [ADSB.lol](https://adsb.lol) - A completely open-source and community-driven flight tracker that displays and provides [ODbL-licensed](https://opendatacommons.org/licenses/odbl/summary/) data via a [free API](https://api.adsb.lol/) as well as [free historical data](https://github.com/adsblol/globe_history) ⭐ 45 | 🐛 0 | 🌐 Shell | 📅 2026-08-17.
...
* [readsb](https://github.com/wiedehopf/readsb) ⭐ 653 | 🐛 10 | 🌐 C | 📅 2026-08-10 - ADS-B decoder swiss knife.
...
* [adsbfi/adsb-fi-scripts](https://github.com/adsbfi/adsb-fi-scripts) ⭐ 179 | 🐛 0 | 🌐 Shell | 📅 2025-08-29 - Easy to use feeder install script for feeding to adsb.fi.
...
* [wiedehopf/tar1090](https://github.com/wiedehopf/tar1090) ⭐ 1,874 | 🐛 57 | 🌐 JavaScript | 📅 2026-07-28 - A great way to view your ADS-B data.
