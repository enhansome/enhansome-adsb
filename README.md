...
* [ADSB.lol](https://adsb.lol) - A completely open-source and community-driven flight tracker that displays and provides [ODbL-licensed](https://opendatacommons.org/licenses/odbl/summary/) data via a [free API](https://api.adsb.lol/) as well as [free historical data](https://github.com/adsblol/globe_history) ⭐ 54 | 🐛 1 | 🌐 Shell | 📅 2026-09-17.
...
* [dump1090](https://github.com/MalcolmRobb/dump1090) ⭐ 1,106 | 🐛 39 | 🌐 C | 📅 2024-08-14 - A simple Mode S decoder for RTLSDR devices.
* [readsb](https://github.com/wiedehopf/readsb) ⭐ 681 | 🐛 11 | 🌐 C | 📅 2026-08-22 - ADS-B decoder swiss knife.
* [junzis/pyModeS](https://github.com/junzis/pyModeS) ⭐ 668 | 🐛 10 | 🌐 Python | 📅 2026-07-23 - A python decoder for Mode S and ADS-B signals.
* [sdr-enthusiasts/plane-alert-db](https://github.com/sdr-enthusiasts/plane-alert-db) ⭐ 143 | 🐛 8 | 🌐 Python | 📅 2026-09-16 - A list of exciting aircraft - Governments, Dictators, Military, Historical and just plain odd.
* [flightmon](https://github.com/mik3y/flightmon) ⭐ 23 | 🐛 1 | 🌐 Go | 📅 2020-06-13 - Simple command-line "GUI" for showing current dump1090/readsb data.
* [adsb\_actions](https://github.com/eastham/adsb_actions) ⭐ 4 | 🐛 8 | 🌐 Python | 📅 2026-08-26 - Python tool to detect, act on, and visualize ADS-B traffic and events.

### Feeding

* [sdr-enthusiasts/docker-adsb-ultrafeeder](https://github.com/sdr-enthusiasts/docker-adsb-ultrafeeder) ⭐ 567 | 🐛 6 | 🌐 Shell | 📅 2026-09-13 - All-in-one ADSB container with readsb, tar1090, graphs1090, autogain, multi-feeder, and mlat-hub built in.
* [adsbfi/adsb-fi-scripts](https://github.com/adsbfi/adsb-fi-scripts) ⭐ 186 | 🐛 0 | 🌐 Shell | 📅 2025-08-29 - Easy to use feeder install script for feeding to adsb.fi.
* [adsblol/feed](https://github.com/adsblol/feed) ⭐ 79 | 🐛 4 | 🌐 Shell | 📅 2024-10-18 - Easy to use, container-based MLAT/ADS-B/ACARS/VDL2 multi feed client. Powered by [SDR-Enthusiasts](https://github.com/sdr-enthusiasts) images.
...
* [wiedehopf/tar1090](https://github.com/wiedehopf/tar1090) ⭐ 1,906 | 🐛 57 | 🌐 JavaScript | 📅 2026-09-05 - A great way to view your ADS-B data.
* [amnesica/BelugaProject](https://github.com/amnesica/BelugaProject) ⭐ 88 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-07 - A web application that displays data of one or multiple, local ADS-B feeders and AIS-data along with additional information on a map interface in the browser.
...
* [Jxck-S/plane-notify](https://github.com/Jxck-S/plane-notify) ⭐ 2,547 | 🐛 10 | 🌐 Python | 📅 2026-09-15 - Notify if a selected plane has taken off or landed using OpenSky or ADS-B Exchange data.
...
* [aircraft-flight-schedules](https://github.com/MrAirspace/aircraft-flight-schedules) ⭐ 28 | 🐛 0 | 📅 2026-09-05 - Open-source datasets featuring global, high-level flight schedules extracted from worldwide aircraft ADS-B position transmissions (2024+ onwards). Covers all flights globally as long as within coverage of the [ADSBlol](https://adsb.lol/) initiative.
...
> **TODO:**
> Please [create a pull request](https://github.com/rickstaa/awesome-adsb/pulls) ⭐ 382 | 🐛 12 | 🌐 HTML | 📅 2026-09-05 if you know people in the ADS-B space that are worth following.

Who else should we [be following](https://github.com/rickstaa/awesome-adsb/issues/new?assignees=\&labels=\&template=suggestion.yaml) ⭐ 382 | 🐛 12 | 🌐 HTML | 📅 2026-09-05?
...
This project exists thanks to all the people [that contributed](https://github.com/rickstaa/awesome-adsb/graphs/contributors) ⭐ 382 | 🐛 12 | 🌐 HTML | 📅 2026-09-05!
