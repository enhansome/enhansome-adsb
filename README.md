...
* [ADSB.lol](https://adsb.lol) - A completely open-source and community-driven flight tracker that displays and provides [ODbL-licensed](https://opendatacommons.org/licenses/odbl/summary/) data via a [free API](https://api.adsb.lol/) as well as [free historical data](https://github.com/adsblol/globe_history) ⭐ 51 | 🐛 1 | 🌐 Shell | 📅 2026-09-09.
...
* [dump1090](https://github.com/MalcolmRobb/dump1090) ⭐ 1,105 | 🐛 39 | 🌐 C | 📅 2024-08-14 - A simple Mode S decoder for RTLSDR devices.
* [readsb](https://github.com/wiedehopf/readsb) ⭐ 672 | 🐛 10 | 🌐 C | 📅 2026-08-22 - ADS-B decoder swiss knife.
* [junzis/pyModeS](https://github.com/junzis/pyModeS) ⭐ 668 | 🐛 10 | 🌐 Python | 📅 2026-07-23 - A python decoder for Mode S and ADS-B signals.
* [sdr-enthusiasts/plane-alert-db](https://github.com/sdr-enthusiasts/plane-alert-db) ⭐ 143 | 🐛 8 | 🌐 Python | 📅 2026-09-03 - A list of exciting aircraft - Governments, Dictators, Military, Historical and just plain odd.
* [flightmon](https://github.com/mik3y/flightmon) ⭐ 22 | 🐛 1 | 🌐 Go | 📅 2020-06-13 - Simple command-line "GUI" for showing current dump1090/readsb data.
...
* [sdr-enthusiasts/docker-adsb-ultrafeeder](https://github.com/sdr-enthusiasts/docker-adsb-ultrafeeder) ⭐ 564 | 🐛 5 | 🌐 Shell | 📅 2026-09-06 - All-in-one ADSB container with readsb, tar1090, graphs1090, autogain, multi-feeder, and mlat-hub built in.
...
* [wiedehopf/tar1090](https://github.com/wiedehopf/tar1090) ⭐ 1,897 | 🐛 57 | 🌐 JavaScript | 📅 2026-09-05 - A great way to view your ADS-B data.
* [amnesica/BelugaProject](https://github.com/amnesica/BelugaProject) ⭐ 87 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-07 - A web application that displays data of one or multiple, local ADS-B feeders and AIS-data along with additional information on a map interface in the browser.
...
* [Jxck-S/plane-notify](https://github.com/Jxck-S/plane-notify) ⭐ 2,547 | 🐛 12 | 🌐 Python | 📅 2026-02-05 - Notify if a selected plane has taken off or landed using OpenSky or ADS-B Exchange data.
...
> **TODO:**
> Please [create a pull request](https://github.com/rickstaa/awesome-adsb/pulls) ⭐ 381 | 🐛 12 | 🌐 HTML | 📅 2026-09-05 if you know people in the ADS-B space that are worth following.

Who else should we [be following](https://github.com/rickstaa/awesome-adsb/issues/new?assignees=\&labels=\&template=suggestion.yaml) ⭐ 381 | 🐛 12 | 🌐 HTML | 📅 2026-09-05?
...
This project exists thanks to all the people [that contributed](https://github.com/rickstaa/awesome-adsb/graphs/contributors) ⭐ 381 | 🐛 12 | 🌐 HTML | 📅 2026-09-05!
