...
* [ADSB.lol](https://adsb.lol) - A completely open-source and community-driven flight tracker that displays and provides [ODbL-licensed](https://opendatacommons.org/licenses/odbl/summary/) data via a [free API](https://api.adsb.lol/) as well as [free historical data](https://github.com/adsblol/globe_history) ⭐ 54 | 🐛 1 | 🌐 Shell | 📅 2026-09-18.
...
* [readsb](https://github.com/wiedehopf/readsb) ⭐ 683 | 🐛 11 | 🌐 C | 📅 2026-08-22 - ADS-B decoder swiss knife.
* [junzis/pyModeS](https://github.com/junzis/pyModeS) ⭐ 668 | 🐛 10 | 🌐 Python | 📅 2026-07-23 - A python decoder for Mode S and ADS-B signals.
* [sdr-enthusiasts/plane-alert-db](https://github.com/sdr-enthusiasts/plane-alert-db) ⭐ 144 | 🐛 8 | 🌐 Python | 📅 2026-09-16 - A list of exciting aircraft - Governments, Dictators, Military, Historical and just plain odd.
...
* [wiedehopf/tar1090](https://github.com/wiedehopf/tar1090) ⭐ 1,908 | 🐛 68 | 🌐 JavaScript | 📅 2026-09-05 - A great way to view your ADS-B data.
